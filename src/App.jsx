...
import InteractiveReconWizard from './components/InteractiveReconWizard';
...
function App() {
  ...
  return (
    <div className="app-container">
      {/* Sidebar Navigation */}
      <aside className={`sidebar ${mobileMenuOpen ? 'mobile-open' : ''}`} style={{ width: '265px' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '18px' }}>
            ...
            <div>
              ...
              <ul style={{ listStyle: 'none', display: 'flex', flexDirection: 'column', gap: '4px' }}>
                <li className={`nav-item ${activeTab === 'recon-module' ? 'active' : ''}`} onClick={() => { setActiveTab('recon-module'); setMobileMenuOpen(false); }}>
                  <RefreshCcw size={17} />
        ...
        <header style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '28px', flexWrap: 'wrap', gap: '20px' }}>
          <div>
            <h1 style={{ fontSize: '24px', marginBottom: '4px' }}>
              {activeTab === 'recon-module' && 'Interactive Reconciliation Module'}
            ...
            <p style={{ fontSize: '13px', color: 'var(--text-secondary)' }}>
              {activeTab === 'recon-module'
                ? 'Step-by-step interactive reconciliation flow with live log streaming and file validation.'
                : (activeTab === 'pipeline' 
